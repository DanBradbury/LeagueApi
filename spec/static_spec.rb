...
describe LeagueApi::Static do
  ...
  context "Riot API Spec" do
    it "should retrieve a champion list" do
      champions = @static.champions
      champions.class.should == ChampionListDto
      #test championListDto here..
      data = champions.data
      data.class.should == Hash
      data["Thresh"].class == ChampionDto
    end
  end

  context "Pre-v1.0 helpers" do
